...
| Data | `supabase/seed_post_pulse.sql` (13 departments after the 2026-09-14 taxonomy change and the Hair, Groom & Feathers addition — `supabase/post_pulse_taxonomy_2026-09-14.sql` — 34 tools) and `WorkingDocs/POST_PULSE_SEED_DATA.json` (earlier, less complete export of the same research) |
