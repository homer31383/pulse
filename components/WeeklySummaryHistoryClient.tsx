  ...
  if (summaries.length === 0) {
    return (
      <main className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-slate-400 font-medium mb-1">No weekly summaries yet</p>
        <p className="text-slate-600 text-sm">Generate a Weekly Summary from the home screen to see history here.</p>
      </main>
    )
  }
          ...
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-600">{formatDate(s.created_at)}</p>
              </div>
              {s.cost_usd != null && (
